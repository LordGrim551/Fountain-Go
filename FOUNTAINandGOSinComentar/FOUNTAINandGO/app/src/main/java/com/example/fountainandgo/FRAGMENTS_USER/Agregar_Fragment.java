...
public class Agregar_Fragment extends Fragment {
    ...
    public Agregar_Fragment() {}

    public static Agregar_Fragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_agregar_, container, false);
    }
}